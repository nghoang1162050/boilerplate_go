...
INSERT INTO `casbin_rule` VALUES (6,'p','admin','/api/auth/me','GET','','',''),(1,'p','admin','/api/products','GET','','',''),(2,'p','admin','/api/products','POST','','',''),(4,'p','admin','/api/products/:id','DELETE','','',''),(5,'p','admin','/api/products/:id','GET','','',''),(3,'p','admin','/api/products/:id','PUT','','','');
